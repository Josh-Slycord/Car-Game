...
public class Client3 extends Thread{
	...
	public Client3(String host, int port, String hostName) {
		this.host = host;
		this.port = port;
	...
	public void run() {
		...
		try {
			new Thread(new ReceivedMessagesHandler3(client.getInputStream())).start();
...
class ReceivedMessagesHandler3 implements Runnable {

	private InputStream server;

	public ReceivedMessagesHandler3(InputStream server) {
		this.server = server;
	}
